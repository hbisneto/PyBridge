...
def CreateExceptions():
    ...
    with codecs.open(CreateEnvironment.ExceptionsFile, "w", "utf-8-sig") as Exceptions:
        ...
        Exceptions.write(f'    print("="*40)')
        Exceptions.write(f'    print(">> PYBRIDGE <<")')
        Exceptions.write(f'    print("="*40)')
        Exceptions.write(f'    print(">> WARNING <<")')
        Exceptions.write(f'    print("="*40)')
        Exceptions.write("    print(f'>> Your appication targets a version of Python older than the version currently\ninstalled. You may get errors during the process')")
        Exceptions.write(f'    print("="*40)')
        ...
        Exceptions.write("    raise Exception(f'{WarnSpacing}{self.exctype} The file already exists')")
        Exceptions.write(f'  ')
        Exceptions.write(f'  def DirectoryExists(self):')
        Exceptions.write("    raise Exception(f'{WarnSpacing}{self.exctype} The directory already exists')")
        Exceptions.write(f'  ')
        ...
        Exceptions.write("    print(f'{self.exctype} The program was already closed!')")
        Exceptions.write(f'    print("=" * 80)')
        ...
        Exceptions.write(f'    print("=" * 80)')
        Exceptions.write(f'')
        Exceptions.write(f'  def ProjectsLoadFail():')
        Exceptions.write(f'    print("=" * 80)')
